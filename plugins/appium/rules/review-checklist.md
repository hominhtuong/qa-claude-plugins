...
- [ ] **A1**: Screen class located in `src/main/java/com/sbh/screens/<group>/`
- [ ] **A2**: Test class located in `src/test/java/com/sbh/tests/<group>/`
...
- [ ] **B5**: Package: `com.sbh.screens.<group>` / `com.sbh.tests.<group>` (group = lowercase)
