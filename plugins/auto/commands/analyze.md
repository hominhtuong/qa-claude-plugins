---
description: Analyze codebase, requirement, test result or project structure (analysis only, no code changes)
argument-hint: <code | requirement | test result | structure to analyze>
