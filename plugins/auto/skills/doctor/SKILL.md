---
name: doctor
description: Check the toolchain for the auto plugin (python/node/wrangler/java/mvn + optional adb/appium) and print the correct install command per OS; optionally auto-install wrangler. Cross-platform. Use when a script reports a missing tool, or to confirm the machine is ready to run tests / push reports / Lark notify.
---
