...
2. **Stage**: `git add` the in-scope files; avoid adding junk/secret files (cross-check `.gitignore` — do not add `results/tests/` run artifacts, `.claude/qa-claude/.plugin.env`, tokens, files containing secrets).
