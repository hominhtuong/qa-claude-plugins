...
6. **Capture evidence** → `results/exploratory/<feature>/screenshots/`, **named by BUG-ID** (e.g. `02-APP01-published-tab-crash.png`). Each `[APP-BUG]` ≥1 image; also save a few OK-screen images (`..-ok.png`) as proof of "checked".
