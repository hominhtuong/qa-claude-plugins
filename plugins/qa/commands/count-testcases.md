---
description: Count the MANUAL test cases in a created sheet/plan and report coverage by feature/section
argument-hint: <xlsx/plan file path | Google/Lark Sheet link | feature name>
...
- If no source is found for a feature → clearly report "Chưa có sheet/plan cho {feature}".
